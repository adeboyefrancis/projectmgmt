...
const Dashboard = () => {
    ...
    // Fetch all workspaces from Spring Boot on app load
    useEffect(() => {
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center h-64">
                <div className="text-zinc-500 dark:text-zinc-400 text-sm animate-pulse">
                    Loading workspaces...
                </div>
            </div>
        )
        ...
        return (
            <div className="flex items-center justify-center h-64">
                <div className="text-red-500 text-sm">
                    Failed to load: {error}. Is the Spring Boot backend running on port 8080?
                </div>
            </div>
        )
    }
